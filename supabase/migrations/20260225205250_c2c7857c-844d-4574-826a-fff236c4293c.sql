...
-- Function to safely delete a user after validating no linked records
...
BEGIN
  ...
  -- Non-global admins can only delete users from their own tenant
  ...
  -- Cannot delete admin_global users
