...
-- Fix: All empresas SELECT policies must be PERMISSIVE (OR logic)
-- RESTRICTIVE means ALL must pass, which breaks admin_global switching
...
-- PERMISSIVE SELECT policies (any one grants access)
